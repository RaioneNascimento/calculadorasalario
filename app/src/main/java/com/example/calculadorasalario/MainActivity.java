...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String SALARIO_BRUTO = "com.igti.calculadorasalario.SALARIO_BRUTO";
    public static final String DEPENDENTES = "com.igti.calculadorasalario.DEDPENDENTES";
    public static final String DESCONTOS = "com.igti.calculadorasalario.DESCONTOS";
